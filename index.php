...
<body>
        ...
        <div class="flex w-full items-center justify-between px-4">
          <div>
            <button id="navbarToggler"
              class="absolute right-4 top-1/2 block -translate-y-1/2 rounded-lg px-3 py-[6px] ring-white focus:ring-2 lg:hidden">
            ...
            <nav id="navbarCollapse"
              ...
              <ul class="blcok lg:flex">
                <li class="group relative">
                  <a href="#home"
                    class="ud-menu-scroll mx-8 flex py-2 text-black group-hover:text-gray-600 lg:mr-0 lg:inline-flex lg:py-6 lg:px-0 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-10">
                    Inicio
                  </a>
                </li>
                <li class="group relative">
                  <a href="#about"
                    class="ud-menu-scroll mx-8 flex py-2 text-black group-hover:text-gray-600 lg:mr-0 lg:ml-7 lg:inline-flex lg:py-6 lg:px-0 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70 xl:ml-12">
                    Nosotros
                  </a>
                </li>
                <!-- <li class="group relative">
                ...
                <!-- <li class="submenu-item group relative">
                    <a
                      ...
                      class="relative mx-8 flex py-2 text-base text-white after:absolute after:right-1 after:top-1/2 after:mt-[-2px] after:h-2 after:w-2 after:-translate-y-1/2 after:rotate-45 after:border-b-2 after:border-r-2 after:border-current group-hover:text-primary lg:mr-0 lg:ml-8 lg:inline-flex lg:py-6 lg:pl-0 lg:pr-4 lg:text-white lg:after:right-0 lg:group-hover:text-white lg:group-hover:opacity-70 xl:ml-12"
                    >
                      Pages
                    </a>
                    <div
          ...
          <div class="hidden justify-end pr-16 sm:flex lg:pr-0">
            <a href="https://www.facebook.com/profile.php?id=61550074004107" target="_blank"
            ...
            <a href="https://www.instagram.com/flgapps/" target="_blank" class="px-3 text-[#dddddd] hover:text-white">
        ...
        <div class="w-full px-4">
          <div class="hero-content wow fadeInUp mx-auto max-w-[780px] text-center" data-wow-delay=".2s">
            <h1
              ...
              Sistemas de Información a medida para tu empresa
            </h1>
            <p
        ...
        <div class="w-full px-4">
          <div class="mb-12 max-w-[620px] lg:mb-20">
            <h2 class="mb-4 text-3xl font-bold text-dark sm:text-4xl md:text-[42px]">
              Empoderando tu Futuro Tecnológico
            </h2>
            <p class="text-lg leading-relaxed text-body-color sm:text-xl sm:leading-relaxed">
              En FLG APPs, estamos entusiasmados por ofrecer soluciones de vanguardia en Sistemas de Información. A
              pesar de ser nuevos en el mercado, estamos comprometidos con la excelencia y la satisfacción del cliente.
              Nuestro objetivo es ayudarte a alcanzar tus metas a través de la tecnología.
            </p>
          </div>
        </div>
      </div>
        ...
        <div class="w-full px-4 md:w-1/2 lg:w-1/3">
          <div class="wow fadeInUp group mb-12 bg-white" data-wow-delay=".1s">
            ...
            <p class="mb-8 text-body-color lg:mb-11">
              Creamos sistemas de información que se ajustan a sus necesidades específicas, desde aplicaciones web y
              móviles hasta soluciones empresariales completas.
            </p>
          </div>
        </div>
        <div class="w-full px-4 md:w-1/2 lg:w-1/3">
          <div class="wow fadeInUp group mb-12 bg-white" data-wow-delay=".15s">
            ...
            <p class="mb-8 text-body-color lg:mb-11">
              Nuestro equipo de expertos en tecnología le asesorará en la elección de las mejores soluciones para su
              negocio y le ayudará a aprovechar al máximo su inversión en tecnología.
            </p>
          </div>
        </div>
        <div class="w-full px-4 md:w-1/2 lg:w-1/3">
          <div class="wow fadeInUp group mb-12 bg-white" data-wow-delay=".2s">
            ...
            <p class="mb-8 text-body-color lg:mb-11">
              Conectamos sus sistemas existentes para que funcionen de manera armoniosa y eficiente, eliminando la
              redundancia de datos y mejorando la colaboración en toda la organización.
            </p>
          </div>
        </div>
      </div>
  ...
  <!-- ====== About Section Start -->
  <section id="about" class="bg-gray-900 pt-20 pb-20 lg:pt-[120px] lg:pb-[120px]">
    <div class="container">
      <div class="-mx-4 flex flex-wrap">
        <div class="w-full px-4">
          <div class="mx-auto mb-[60px] max-w-[620px] text-center">
            <h2 class="mb-4 text-3xl font-bold text-white sm:text-4xl md:text-[42px]">
              Acerca de nosotros
            </h2>
          </div>
          <div class="items-center justify-between overflow-hidden lg:flex">
            <div
              ...
              <h3 class="text-2xl font-bold text-white dark:text-white">Experiencia y Pasión</h3>

              <p class="mb-9 text-base leading-relaxed text-gray-400">
                Aunque somos nuevos, nuestro equipo está formado por expertos apasionados por la tecnología y la
                innovación.
              </p>

              <h3 class="text-2xl font-bold text-white dark:text-white">Compromiso con la Calidad</h3>
              <p class="mb-9 text-base leading-relaxed text-gray-400">
                Nos esforzamos por ofrecer sistemas de la más alta calidad, diseñados para satisfacer tus necesidades
                específicas.
              </p>
              <h3 class="text-2xl font-bold text-white dark:text-white">Soluciones Personalizadas</h3>
              <p class="mb-9 text-base leading-relaxed text-gray-400">
                Trabajamos codo a codo contigo para crear soluciones personalizadas que se adapten a tu negocio.
              </p>
            </div>
            <div class="text-center">
              <div class="relative z-10 inline-block">
                <img src="assets/images/about/about-image.jpg" alt="image" class="mx-auto lg:ml-auto" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="-mx-4 flex flex-wrap">
        <div class="w-full px-4">
          <div class="mx-auto mb-[60px] max-w-[620px] text-center">
            ...
            <h4 class="mb-2 block text-lg font-bold text-secondary">
              Conozca a nuestro equipo
            </h4>
            <p class="text-lg leading-relaxed text-body-color sm:text-xl sm:leading-relaxed">
              Detrás de cada solución exitosa hay un equipo de expertos dedicados. Nuestros compañeros son apasionados
              por su trabajo y están altamente capacitados en las últimas tecnologías. Trabajan incansablemente para
              asegurarse de que su proyecto sea un éxito.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="-mx-4 flex flex-wrap justify-center">
        <div class="w-full px-4 sm:w-1/2 lg:w-1/3">
          <div class="wow fadeInUp mb-10" data-wow-delay=".1s">
            <div class="h-170px] relative z-10 mx-auto mb-6 w-[170px] rounded-full">
              <img src="assets/images/team/team-01.jpeg" alt="image" class="w-full rounded-full" />
            ...
            <div class="text-center">
              ...
              <div class="flex items-center justify-center">
                ...
                <a href="https://instagram.com/facundosegarra/" target="_blank"
                  class="mx-2 flex h-8 w-8 items-center justify-center text-[#cdced6] hover:text-primary">
                  <svg width="18" height="18" viewBox="0 0 18 18" class="fill-current">
                    <path
                ...
                <a href="https://www.linkedin.com/in/facundo-segarra-920317b7/" target="_blank" class="px-3 text-[#dddddd] hover:text-white">
                  <svg width="18" height="18" viewBox="0 0 18 18" class="fill-current">
                    <path
                      d="M16.7821 0.947388H1.84847C1.14272 0.947388 0.578125 1.49747 0.578125 2.18508V16.7623C0.578125 17.4224 1.14272 18 1.84847 18H16.7257C17.4314 18 17.996 17.4499 17.996 16.7623V2.15757C18.0525 1.49747 17.4879 0.947388 16.7821 0.947388ZM5.7442 15.4421H3.17528V7.32837H5.7442V15.4421ZM4.44563 6.2007C3.59873 6.2007 2.94944 5.5406 2.94944 4.74297C2.94944 3.94535 3.62696 3.28525 4.44563 3.28525C5.26429 3.28525 5.94181 3.94535 5.94181 4.74297C5.94181 5.5406 5.32075 6.2007 4.44563 6.2007ZM15.4835 15.4421H12.9146V11.509C12.9146 10.5739 12.8864 9.33618 11.5596 9.33618C10.2045 9.33618 10.0069 10.3813 10.0069 11.4265V15.4421H7.438V7.32837H9.95046V8.45605H9.9787C10.3457 7.79594 11.1644 7.13584 12.4347 7.13584C15.0601 7.13584 15.54 8.7861 15.54 11.0414V15.4421H15.4835Z" />
                  </svg>
        ...
        <div class="w-full px-4 sm:w-1/2 lg:w-1/3">
          <div class="wow fadeInUp mb-10" data-wow-delay=".15s">
            <div class="h-170px] relative z-10 mx-auto mb-6 w-[170px] rounded-full">
              <img src="assets/images/team/team-02.jpeg" alt="image" class="w-full rounded-full" />
              <span class="absolute top-0 left-0 z-[-1]">
                <svg width="71" height="82" viewBox="0 0 71 82" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="1.29337" cy="80.7066" r="1.29337" transform="rotate(-90 1.29337 80.7066)"
                    fill="#3056D3" />
            ...
            <div class="text-center">
              <h4 class="mb-2 text-lg font-medium text-dark">Sebastián Duarte</h4>
              <p class="mb-5 text-sm font-medium text-body-color">
                Cofundador y Desarrollador Backend
              </p>
              <div class="flex items-center justify-center">
                <a href="https://www.facebook.com/profile.php?id=100010232820575" target="_blank"
                  class="mx-2 flex h-8 w-8 items-center justify-center text-[#cdced6] hover:text-primary">
                  <svg width="10" height="18" viewBox="0 0 10 18" class="fill-current">
                    <path
                      d="M9.29878 7.2H7.74898H7.19548V6.61935V4.81936V4.23871H7.74898H8.91133C9.21575 4.23871 9.46483 4.00645 9.46483 3.65806V0.580645C9.46483 0.26129 9.24343 0 8.91133 0H6.89106C4.70474 0 3.18262 1.62581 3.18262 4.03548V6.56129V7.14194H2.62912H0.747223C0.359774 7.14194 0 7.46129 0 7.92581V10.0161C0 10.4226 0.304424 10.8 0.747223 10.8H2.57377H3.12727V11.3806V17.2161C3.12727 17.6226 3.43169 18 3.87449 18H6.47593C6.64198 18 6.78036 17.9129 6.89106 17.7968C7.00176 17.6806 7.08478 17.4774 7.08478 17.3032V11.4097V10.829H7.66596H8.91133C9.2711 10.829 9.54785 10.5968 9.6032 10.2484V10.2194V10.1903L9.99065 8.1871C10.0183 7.98387 9.99065 7.75161 9.8246 7.51935C9.76925 7.37419 9.52018 7.22903 9.29878 7.2Z" />
                ...
                <a href="https://www.instagram.com/sebateunmate/" target="_blank"
                  class="mx-2 flex h-8 w-8 items-center justify-center text-[#cdced6] hover:text-primary">
                  <svg width="18" height="18" viewBox="0 0 18 18" class="fill-current">
                    <path
                      d="M8.90245 12.1939C10.7363 12.1939 12.2229 10.7073 12.2229 8.87352C12.2229 7.0397 10.7363 5.5531 8.90245 5.5531C7.06863 5.5531 5.58203 7.0397 5.58203 8.87352C5.58203 10.7073 7.06863 12.1939 8.90245 12.1939Z" />
                ...
                <a href="https://www.linkedin.com/in/sebastian-exequiel-duarte-79767320b/" target="_blank" class="px-3 text-[#dddddd] hover:text-white">
                  <svg width="18" height="18" viewBox="0 0 18 18" class="fill-current">
                    <path
                      d="M16.7821 0.947388H1.84847C1.14272 0.947388 0.578125 1.49747 0.578125 2.18508V16.7623C0.578125 17.4224 1.14272 18 1.84847 18H16.7257C17.4314 18 17.996 17.4499 17.996 16.7623V2.15757C18.0525 1.49747 17.4879 0.947388 16.7821 0.947388ZM5.7442 15.4421H3.17528V7.32837H5.7442V15.4421ZM4.44563 6.2007C3.59873 6.2007 2.94944 5.5406 2.94944 4.74297C2.94944 3.94535 3.62696 3.28525 4.44563 3.28525C5.26429 3.28525 5.94181 3.94535 5.94181 4.74297C5.94181 5.5406 5.32075 6.2007 4.44563 6.2007ZM15.4835 15.4421H12.9146V11.509C12.9146 10.5739 12.8864 9.33618 11.5596 9.33618C10.2045 9.33618 10.0069 10.3813 10.0069 11.4265V15.4421H7.438V7.32837H9.95046V8.45605H9.9787C10.3457 7.79594 11.1644 7.13584 12.4347 7.13584C15.0601 7.13584 15.54 8.7861 15.54 11.0414V15.4421H15.4835Z" />
                  </svg>
          ...
          <div class="ud-contact-content-wrapper">
            ...
            <div class="mb-12 flex flex-wrap justify-between lg:mb-0">
              <div class="mb-8 flex w-[330px] max-w-full">
                ...
                <div>
                  <h5 class="mb-6 text-lg font-semibold">Nuestra Ubicación</h5>
                  <p class="text-base text-body-color">
                    Casilda (2170), Santa Fe - Argentina
                  </p>
                </div>
              </div>
              <div class="mb-8 flex w-[330px] max-w-full">
          ...
          <div
            ...
            <div class="mb-6">
              ...
              <div class="mb-6">
                ...
                <input type="email" name="email" placeholder="ejemplo@sumail.com"
                  class="w-full border-0 border-b border-[#f1f1f1] py-4 focus:border-primary focus:outline-none" />
              </div>
              <div class="mb-6">
                <label for="phone" class="block text-xs text-dark">Teléfono*</label>
                <input type="text" name="phone" placeholder="(0341) 155 555 555"
                  class="w-full border-0 border-b border-[#f1f1f1] py-4 focus:border-primary focus:outline-none" />
              </div>
              <div class="mb-6">
        ...
        <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
          <div class="mb-10 w-full">
            ...
            <p class="mb-7 text-base text-[#f3f4fe]">
              Creamos experiencias digitales para marcas y empresas a través del uso de la tecnología.
            </p>
